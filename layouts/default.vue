      ...
      <v-app class="text-right">
            ...
            <v-list-item-group color="primary">
              ...
              <v-expansion-panels flat>
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    <v-list-item>
                      <v-icon class="ml-2">mdi-card-account-details-star-outline
                      </v-icon>
                      <v-list-item-title>سفارشات</v-list-item-title>
                    </v-list-item>
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    <v-list-item to="/offers/active/me">سفارشات در جریان
                    </v-list-item>
                    <v-list-item to="/offers/me">تاریخچه سفارشات</v-list-item>
                    <v-list-item to="/trades/me">معاملات</v-list-item>
              ...
              <v-expansion-panels flat>
                <v-expansion-panel>
                  <v-expansion-panel-header>
                    <v-list-item>
                      <v-icon class="ml-2">mdi-badge-account-horizontal-outline
                      </v-icon>
                      <v-list-item-title>حسابداری مالی</v-list-item-title>
                    </v-list-item>
                  </v-expansion-panel-header>
                  <v-expansion-panel-content>
                    <v-list-item to="/wallets/me/withdraws">گزارش برداشت
                    </v-list-item>
              ...
              <v-expansion-panels flat>
                <v-expansion-panel>
                  ...
                  <v-expansion-panel-content>
                    ...
                    <v-list-item to="/messages/settings">مدیریت اعلان ها
                    </v-list-item>
                  </v-expansion-panel-content>
                </v-expansion-panel>
              </v-expansion-panels>
        ...
        <v-main>
          <v-container fluid class="py-4 px-0">
            <bitra-banner v-for="(i, key) in allPagesBanners" :item="i" :key="key" />
            <nuxt />
          </v-container>
          <v-snackbar v-model="snackBar.normal.show">{{ snackBar.normal.msg }}
          </v-snackbar>
          <v-snackbar color="green" v-model="snackBar.success.show">{{ snackBar.success.msg }}
          </v-snackbar>
          <v-snackbar color="red" v-model="snackBar.fail.show">{{ snackBar.fail.msg }}
          </v-snackbar>
        </v-main>
