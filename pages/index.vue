<template>
  <div>
    ...
    <v-alert v-if="true" color="error" class="text-display-2 px-12" shaped elevation="2">
      <ul>
        پیرو دستور مقام محترم قضایی، معاملات توکن دریک به علت تخلفات قانونی ناشر تا اطلاع ثانوعی مسدود میباشد. اطلاعات تکمیلی در کانالهای ارتباطی رسمی بیترا حضور کاربران اعلام میگردد.
      </ul>
    </v-alert>
