      ...
      <v-col cols=3>
        <v-card class="pa-6" width=100% height="100%">
          ...
          <div v-if="exchangeAction === 'buy'">
            <p><span>دفعه:</span>{{ bulkCounter }}</p>
            <a-text-field class="mb-4" v-model="howManyTimes" label="تعداد بار"/>
          ...
          <div v-else-if="exchangeAction === 'sell'">
            ...
            <v-form v-model="sellForm" @submit.prevent="bulkSell" class="mt-3">
              <a-text-field v-model="howManyTimes" label="تعداد بار"/>
