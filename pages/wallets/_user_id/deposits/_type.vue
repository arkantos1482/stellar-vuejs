    ...
    <v-dialog v-model="d.create" width="520px">
      <v-card class="px-12 py-6">
        ...
        <ul class="text-display-2">
          <li>
            عرضه توکن‌های خصوصی بخشی از خدمات {{ fa.company }} است. آنچه درمورد
            ویژگی‌ها و امتیازات آن‌ها در سایت و شبکه‌های اجتماعی
            {{ fa.company }} ارائه می‌شود، فقط برای اطلاعات عمومی ارائه شده است
            و به‌هیچ‌وجه پیشنهاد خرید یا فروش و توصیه به سرمایه‌گذاری در آن
            نمی‌باشد. هرگونه اظهارنظر در خصوص آن‌ها نظر شخصی گوینده است و هیچ
            تضمینی برای کامل بودن یا صحت آن وجود ندارد.
          </li>
          <li>
            {{ fa.company }} در قبال زیان احتمالی ناشی از سرمایه‌گذاری در آن‌ها
            و صحت اطلاعاتی که از سوی ناشر در خصوص آن‌ها گفته می‌شود هیچ‌گونه
            مسئولیتی ندارد. به همه کاربران صرف‌نظر از تجربه و دانش، اکیداً توصیه
            می‌شود قبل از آزمایش هر یک از محصولات ارائه‌شده توسط شرکت‌های خصوصی،
          ...
          <li>
            ...
            لذا از همه کاربران خواسته می‌شود دوباره شرایط و قوانین
            {{ fa.company }} را مطالعه نموده و با قبول قوانین و مقررات نسبت به
            معامله در بازار توکنها اقدام‌نمایند.
          </li>
        </ul>
